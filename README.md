...
## Top Predictive Features:
	Total Revenue, Contract Type, Total Charges, Monthly Charge, Total Long Distance Charges, and Age were identified as the most 
 	influential variables for churn prediction.
